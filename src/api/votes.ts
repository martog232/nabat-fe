import type { MyVoteResponse, VoteRequest, VoteStats } from '../types'
import { apiClient } from './client'

export const votesApi = {
  vote: (alertId: string, data: VoteRequest) =>
    apiClient.post<void>(`/alerts/${alertId}/votes`, data).then((r) => r.data),

  removeVote: (alertId: string) =>
    apiClient.delete<void>(`/alerts/${alertId}/votes`).then((r) => r.data),
